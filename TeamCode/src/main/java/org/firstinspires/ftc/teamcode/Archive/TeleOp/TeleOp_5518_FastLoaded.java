...
import org.firstinspires.ftc.teamcode.Archive.Libs.AR.AR_Arm_Fisher;
import org.firstinspires.ftc.teamcode.Archive.Libs.AR.MecanumDrive_5518;

@TeleOp(name = "TeleOp_5518_FastLoaded", group = "TeleOp")
public class TeleOp_5518_FastLoaded extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad1.left_trigger != 0) {
                mecanumDrive.setBoost(1.0); // It was 1
            }
            else {
                mecanumDrive.setBoost(0.0);
            }
